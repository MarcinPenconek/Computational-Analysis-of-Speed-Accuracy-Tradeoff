...
plot(simulation[,1][simulation[,1] > 0 & simulation[,1] < 2000 & simulation[,4] == 1 & simulation[,2] >= 90  & simulation[,2] <= 111] - 1000, 
     simulation[,2][simulation[,1] > 0 & simulation[,1] < 2000 & simulation[,4] == 1 & simulation[,2] >= 90 & simulation[,2] <= 111], 
     pch = 124, col = "black", cex = 0.8, xlab = "Time (ms)", ylab = "Neurons in A and B", cex.axis = osie, cex.lab = opis)
